...
def search_tool(query: str) -> str:
    """
    tool for up-to-date information on exercises, fitness concepts, or nutrition. 
    useful for when you need to verify exercise form or find new workout ideas.
    """
...
def save_workout_plan(plan: str, filename: str) -> str:
    """
    tool save generated workout plan as JSON file.
    The 'plan' should be a valid JSON string.
    The 'filename' should be ending in .json.
    """
